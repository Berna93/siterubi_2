                                    ...
                                    <form role="form" action="add_user.php" data-toggle="validator" method="post">
                                       ...
                                       <div class="form-group">
                                         ...
                                         <div class="form-group">
                                            ...
                                            <div class="input-group input-append">
                                             <span class="input-group-addon add-on"><span class="glyphicon glyphicon-eye-open"></span></span>
                                            <input type="text" class="form-control" maxlength="30" name="user['username_var']" placeholder="Digite o login do usuário..." type="text"
                                        ...
                                        <span class="input-group-addon add-on"><span class="glyphicon glyphicon-qrcode"></span></span>
                                            <input type="password" maxlength="50" class="form-control" name="user['password_var']" placeholder="Informe a senha do usuário..." data-error="Por favor, informe uma senha válida." required/>
